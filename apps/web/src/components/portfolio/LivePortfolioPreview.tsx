...
import { Laptop, Tablet, Smartphone, Sparkles, FolderPlus } from 'lucide-react';
...
export const LivePortfolioPreview: React.FC = () => {
  ...
  const displayHeadline = user?.headline || 'Software Engineer & Builder';
  const subdomain = portfolio.subdomain || displayName.toLowerCase().replace(/\s+/g, '-');
        ...
        >
          ...
          <div className="p-6 space-y-6 text-neutral-100">
            ...
            <div className="space-y-3">
              ...
              {nodes.length === 0 ? (
                <div className="p-6 text-center rounded-xl border border-dashed border-neutral-800 bg-neutral-950/40 space-y-1.5">
                  <FolderPlus className="w-6 h-6 text-neutral-600 mx-auto" />
                  <p className="text-xs font-semibold text-neutral-300">No projects added yet</p>
                  <p className="text-[10px] text-neutral-500">
                    Log projects in your Career Graph to feature them on your site.
                  </p>
                </div>
              ) : (
                <div className="space-y-3">
